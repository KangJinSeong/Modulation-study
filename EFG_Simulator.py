...
class Simulator(ICAT.Analytic):
    ...
    def ADC(self):
        ...
        # phi = np.arctan2(d_result.imag,d_result.real)
        # plt.figure()
        # plt.plot(t1,phi)
        ...
        plt.figure()
        plt.plot(t2,en_filtered_y, label = 'Taps1');plt.plot(t2,en_filtered_y1, label = 'Taps2');plt.grid()
